...
//    
    func updatePrice(json : JSON) {
        ...
        if let currentPrice = json["ask"].double {
        
            bitcoinPriceLabel.text = currencySymbolSelected + String(currentPrice)
